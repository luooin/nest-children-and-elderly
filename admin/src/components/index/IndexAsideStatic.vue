<template>
	<div class="menu-preview">
		<!-- 竖向-2 -->
		<el-scrollbar :wrap-class="isCollapse
				? 'scrollbar-wrapper scrollbar-wrapper-close'
				: 'scrollbar-wrapper scrollbar-wrapper-open'
			">
			<el-button :style="verticalStyle2[isCollapse ? 'close' : 'open'].btn.default" type="primary"
				@click="collapse">
				<span class="icon iconfont" :style="verticalStyle2[isCollapse ? 'close' : 'open'].btn.icon.default
					" :class="verticalStyle2[isCollapse ? 'close' : 'open'].btn.icon.text"></span>{{ verticalStyle2[isCollapse ?
			"close" : "open"].btn.text }}
			</el-button>
			<!-- <div class="userinfo" :style="verticalStyle2[isCollapse ? 'close' : 'open'].userinfo.box.default
				...
				<el-image v-if="avatar" :style="verticalStyle2[isCollapse ? 'close' : 'open'].userinfo.img.default
					" :src="avatar
				? this.$base.url + avatar
				: require('@/assets/img/avator.png')
			" fit="cover"></el-image>
				<div :style="verticalStyle2[isCollapse ? 'close' : 'open'].userinfo.nickname
						.default
					">
			...
			<el-menu :default-active="activeMenu" :unique-opened="true"
				:style="verticalStyle2[isCollapse ? 'close' : 'open'].menu.box.default" class="el-menu-vertical-2"
				:collapse-transition="false" :collapse="isCollapse">
				<el-menu-item class="home" :popper-append-to-body="false" popper-class="home"
					@click.native="menuHandler('')" :style="verticalStyle2[isCollapse ? 'close' : 'open'].home.one.box.default
						" index="/">
					<div class="el-tooltip">
						<i :style="verticalStyle2[isCollapse ? 'close' : 'open'].home.one.icon
								.default
							" class="icon iconfont icon-shouye-zhihui"></i>
						<span :style="verticalStyle2[isCollapse ? 'close' : 'open'].home.one.title
								.default
							" slot="title">{{ verticalStyle2.open.home.one.title.text }}</span>
					</div>
				</el-menu-item>
				<el-submenu class="user" popper-class="user" :popper-append-to-body="false" :style="verticalStyle2[isCollapse ? 'close' : 'open'].user.one.box.default
					" index="1">
					<template slot="title">
						<i :style="verticalStyle2[isCollapse ? 'close' : 'open'].user.one.icon
								.default
							" class="icon iconfont icon-kuaijiezhifu"></i>
						<span :style="verticalStyle2[isCollapse ? 'close' : 'open'].user.one.title
								.default
				...
				<template v-for="(menu, index) in menuList.backMenu">
					<el-submenu v-if="menu.child.length > 1 || !verticalIsMultiple" class="other" popper-class="other"
						:popper-append-to-body="false" :style="verticalStyle2[isCollapse ? 'close' : 'open'].menu.one.box.default
							" :index="index + 2 + ''">
						<template slot="title">
							<i :style="verticalStyle2[isCollapse ? 'close' : 'open'].menu.one.icon
									.default
								" class="el-icon-menu" :class="icons[index]"></i>
							<span :style="verticalStyle2[isCollapse ? 'close' : 'open'].menu.one.title
									.default
			...
			verticalStyle2: {
				...
				close: {
					...
					menu: {
						...
						one: {
							box1: {
								hover: { color: "#000", background: "#232929" },
								active: { color: "#000", background: "#232929" },
								default: {
									cursor: "pointer",
									padding: "0 8px",
									whiteSpace: "nowrap",
					...
					btn: {
						icon: {
							hover: {},
							default: { color: "#000", margin: "0", fontSize: "30px" },
							text: "icon-menu08",
						},
						hover: { opacity: "0.8" },
						default: {
							...
							padding: "8px 20px",
							boxShadow:
								"0px 9px 0px 0px #2196F3, 0 -9px 0px 0px #2196F3, 4px 0 15px -4px rgba(0, 0, 0, 0.16), -4px 0 15px -4px rgba(0, 0, 0, 0.12)",
							margin: "0",
							color: "#333",
							outline: "none",
							borderRadius: "0px",
					...
					user: {
						two: {
							title: {
								hover: {
									padding: "0 0px",
									backgroundColor: "#1c2324!important",
									lineHeight: "40px",
									color: "#000",
									height: "40px",
								},
					...
					home: {
						...
						one: {
							box1: {
								hover: { color: "#000", background: "rgba(86,178,198,.8)" },
								active: { color: "#000", background: "rgba(86,178,198,.8)" },
								default: {
									cursor: "pointer",
									padding: "0 8px",
									whiteSpace: "nowrap",
				...
				open: {
					...
					box: {
						...
						default: {
							boxShadow:
								"0 2px 5px 0 rgba(239, 235, 235, 0.16), 0 2px 10px 0 rgba(72, 70, 70, 0.12)",
							padding: "60px 0",
							borderColor: "#ddd",
							bottom: "0",
							transition: "width 0.3s",
							...
							left: "0",
							background:
								"url(http://codegen.caihongy.cn/20231101/f4f904c6cb7d4bbbb1961e421d552c38.png) no-repeat center 16px,#ffffff",
							borderWidth: "0",
							width: "240px",
							fontSize: "14px",
							position: "fixed",
					...
					menu: {
						...
						box: {
							...
							default: {
								...
								flexWrap: "wrap",
								background:
									"url(http://codegen.caihongy.cn/20231101/be76ca60a8df4cf7885c09f1f4cd60e8.png) no-repeat 25px top",
								display: "flex",
								position: "relative",
							},
						},
					...
					btn: {
						icon: {
							hover: {},
							default: { color: "#333", margin: "0px 2px", fontSize: "30px" },
							text: "icon-shanchu9",
						},
						hover: { opacity: "0.8" },
						default: {
