	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","fontSize":"14px","color":"#666","background":"#fff"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="内容" prop="content">
					<el-input v-model="ruleForm.content" placeholder="内容" clearable  :readonly="ro.content"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' v-else class="input" label="内容" prop="content">
					<el-input v-model="ruleForm.content" placeholder="内容" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="格式(1:文字，2:图片)" prop="format">
					<el-input v-model.number="ruleForm.format" placeholder="格式(1:文字，2:图片)" clearable  :readonly="ro.format"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' v-else class="input" label="格式(1:文字，2:图片)" prop="format">
					<el-input v-model="ruleForm.format" placeholder="格式(1:文字，2:图片)" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="消息已读(0:未读，1:已读)" prop="isread">
					<el-input v-model.number="ruleForm.isread" placeholder="消息已读(0:未读，1:已读)" clearable  :readonly="ro.isread"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"auto","fontSize":"inherit"}' v-else class="input" label="消息已读(0:未读，1:已读)" prop="isread">
