...
<div :style='{"width":"100%","padding":"30px 18% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="120px"
    >
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="服务名称" prop="fuwumingcheng">
          ...
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="发布时间" prop="fabushijian">
              <el-date-picker
          ...
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="服务内容" prop="fuwuneirong">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="服务内容"
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('zixunfuwu/list', {
							...
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`zixunfuwu/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
